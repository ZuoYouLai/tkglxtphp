 ...
 *
 */
class FamousModel extends CI_Model {
	private $tableName='famous';
	...
	function getListByPage($pageSize,$pageIndex,$strWhere,$orderBy){
		$sql = "SELECT a.*,b.nick_name FROM jooli_".$this->tableName." a INNER JOIN jooli_member b ON a.create_id=b.id";
		if ($strWhere != '')
		$sql .= " WHERE " . $strWhere;
		if ($orderBy != '')
