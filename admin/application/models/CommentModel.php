...
class CommentModel extends CI_Model {
	...
	function getListByPage($pageSize,$pageIndex,$strWhere,$orderBy){
		$sql = "SELECT a.*,c.nick_name FROM jooli_".$this->tableName." a INNER JOIN jooli_post b ON a.sub_id=b.id INNER JOIN jooli_member c ON a.create_id=c.id WHERE sub_type=1";
		if ($strWhere != '')
		$sql .= " AND " . $strWhere;
		if ($orderBy != '')
