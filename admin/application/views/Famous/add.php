...
<body>
    <div class="admin">
	    <div class="tab">
	        <div class="tab-head">
	            <strong>添加名媛专题</strong>
	            <ul class="tab-nav">
	                <li class="active"><a href="#tab-set" onclick="$('#tab-focus').hide();">基本信息</a></li>
	            </ul>
	        </div>
	        <div class="tab-body">
	        <form method="post" class="form-x" action="index.php/Famous/add">
	            ...
	            <div class="tab-panel active" id="tab-set">
	                <div class="form-group">
	                    <div class="label">
	                        <label>标题</label></div>
	                    <div class="field">
	                        <input type="text" class="input" id="title" name="title" size="50" placeholder="标题" data-validate="required:请填写标题" />
	                    </div>
	                </div>
	                <div class="form-group">
	                    <div class="label">
	                        ...
	                        if ($lady){
	                        	...
	                        	for($i=0;$i<count($lady);$i++){
	                        		...
	                        		<li style="float:left;margin-right:20px;">
	                                    ...
	                                    <input name="create_id" value="<?php echo $lady[$i]['id']; ?>" <?php echo $i==0?'checked="checked"':''; ?> type="radio"><?php echo $lady[$i]['nick_name']; ?></label>
	                        		</li>
	                        		<?php 
	                        	}
	                        	?>	
	                ...
	                <div class="form-group">
	                    ...
	                    <div class="field">
	                        <textarea id="description" name="description" maxlength="100" class="input" rows="5" cols="50" placeholder="请填写专题描述" data-validate="required:请填写专题描述,length#<200:小于200汉字"></textarea>
	                    </div>
	                </div>
	                <div class="form-group">
	                    <div class="label">
