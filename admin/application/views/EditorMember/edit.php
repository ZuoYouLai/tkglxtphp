        ...
        <div class="tab">
            ...
            <div class="tab-body">
                ...
                <div class="tab-panel active" id="tab-set">
                    <form method="post" class="form-x" action="index.php/EditorMember/edit">
	                ...
	                <div class="form-group">
                        ...
                        <div class="field">
                            <input type="text" class="input" id="nick_name" name="nick_name" size="50" value="<?php echo $member['nick_name']; ?>" placeholder="会员昵称" data-validate="required:请填写会员昵称" />
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="label">
                    ...
                    <div class="form-group">
                        ...
                        <div class="field">
                            <input type="password" class="input" id="password" value="<?php echo $member['password']; ?>" name="password" size="50" placeholder="登录密码" data-validate="required:请填写登录密码" />
                        </div>
                    </div>
