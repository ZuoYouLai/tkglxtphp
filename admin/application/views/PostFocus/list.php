...
<body>
	<div class="admin">
        <form method="post" class="form-x" action="index.php/postFocus/index">
                    	...
                    	<div class="container">
					        <div class="hero-gallery js-flickity">
					            <div class="hero-gallery__cell hero-gallery__cell--1">
					            	<?php echo $focus[0]['path']==null?'<div class="content-wrap"><h1>1</h1></div>':'<img style="width:100%;" alt="" url="'.$focus[0]['url'].'" src="'.$focus[0]['path'].'">'; ?>
					            </div>
					            <div class="hero-gallery__cell hero-gallery__cell--2">
					                <?php echo $focus[1]['path']==null?'<div class="content-wrap"><h1>2</h1></div>':'<img style="width:100%;" alt="" url="'.$focus[1]['url'].'" src="'.$focus[1]['path'].'">'; ?>
					            </div>
					            <div class="hero-gallery__cell hero-gallery__cell--3">
					                <?php echo $focus[2]['path']==null?'<div class="content-wrap"><h1>3</h1></div>':'<img style="width:100%;" alt="" url="'.$focus[2]['url'].'" src="'.$focus[2]['path'].'">'; ?>
					            </div>
					            <div class="hero-gallery__cell hero-gallery__cell--4">
					                <?php echo $focus[3]['path']==null?'<div class="content-wrap"><h1>4</h1></div>':'<img style="width:100%;" alt="" url="'.$focus[3]['url'].'" src="'.$focus[3]['path'].'">'; ?>
					            </div>
					            <div class="hero-gallery__cell hero-gallery__cell--5">
					                <?php echo $focus[4]['path']==null?'<div class="content-wrap"><h1>5</h1></div>':'<img style="width:100%;" alt="" url="'.$focus[4]['url'].'" src="'.$focus[4]['path'].'">'; ?>
					            </div>
					        </div>
					    </div>
                    </td>
