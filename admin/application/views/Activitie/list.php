    ...
    <div class="admin">
        ...
        <div class="panel admin-panel">
            ...
            <div class="padding border-bottom">
                ...
                <input type="button" class="button button-small border-green" value="添加专题" onclick="location.href='index.php/Activitie/add';" />
                ...
                if ($activitie){
                	foreach ($activitie as $item){
                		...
                		<tr>
		                    ...
		                    <td>
		                        <a href="<?php echo 'http://jooli.uenet.cn/index.php?activitie&cmd=index&id='.$item['id']; ?>" target="_blank"><?php echo 'http://jooli.uenet.cn/index.php?activitie&cmd=index&id='.$item['id']; ?></a>
		                    </td>
				            <td>
				                <?php echo $item['status']=='1'?'已发布':'草稿'; ?>
				            </td>
		                    <td>
		                        <a class="button border-blue button-little" href="index.php/Activitie/edit?id=<?php echo $item['id']; ?>">修改</a> 
