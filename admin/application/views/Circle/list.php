    ...
    <div class="admin">
        ...
        <div class="panel admin-panel">
            <div class="panel-head">
                <strong>圈子列表</strong></div>
            <div class="padding border-bottom">
                <input type="button" class="button button-small checkall" name="checkall" checkfor="id"
                    value="全选" />
                <input type="button" class="button button-small border-green" onclick="location.href='index.php/Circle/add';" value="添加圈子" />
                ...
                if ($circle){
                	foreach ($circle as $item){
                		...
                		<tr>
		                    ...
		                    <td>
		                        <?php echo $item['parentName']; ?>
		                    </td>
		                    <td>
		                        <img alt="" width="34" height="34" src="<?php echo $item['logo']; ?>">
		                    </td>
		                    <td>
		                        <?php echo CutString(strip_tags($item['intro']), 60); ?>...
		                    </td>
		                    <td>
		                        <a class="button border-blue button-little" href="index.php/circle/edit?id=<?php echo $item['id']; ?>">修改</a> 
