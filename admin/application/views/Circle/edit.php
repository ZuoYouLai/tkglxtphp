        ...
        <div class="tab">
            ...
            <div class="tab-body">
                ...
                <div class="tab-panel active" id="tab-set">
                    <form method="post" class="form-x" action="index.php/Circle/edit">
                    <div style="display:none;">
	                	<input type="hidden" name="cmd" value="submit" />
	                	<input type="hidden" name="id" value="<?php echo $circle['id']; ?>" />
	                </div>
                            ...
                            <select id="pid" name="pid" class="input">
                            	...
                            	if ($parent){
                            		foreach ($parent as $item){
                            			?>
                            			<option value="<?php echo $item['id']; ?>" <?php echo $circle['pid']==$item['id']?'selected="selected"':''; ?>><?php echo $item['name']; ?></option>
                            			<?php 
                            		}
                            	}
                            	?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="field">
                            <input type="text" class="input" maxlength="10" id="name" name="name" size="50" value="<?php echo $circle['name']; ?>" placeholder="分类名称" data-validate="required:请填写分类名称" />
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="label">
                        ...
                        <div class="field">
                        	<input type="hidden" id="logo" name="logo" value="<?php echo $circle['logo']; ?>" />
                            <a class="button input-file" href="javascript:BrowseServer('logo');">+ 浏览文件</a>
                            <img alt="" width="34" height="34" src="<?php echo $circle['logo']; ?>">
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="label">
                        ...
                        <div class="field">
                            <textarea id="intro" name="intro" maxlength="100" class="input" rows="5" cols="50" placeholder="请填写圈子描述"><?php echo $circle['intro']; ?></textarea>
                        </div>
                    </div>
